...
// Called by Claude Code hooks (SessionStart / Stop).
// Usage: node wsidn-session-hook.mjs [start|stop]
...
async function main() {
  ...
  const endpoint = hookType === 'stop' ? '/hook/session-stop' : '/hook/session-start';
